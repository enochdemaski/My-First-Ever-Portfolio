...
function App() {
  return (
    <>
      ...
      <section className="containers shadow-[0_0_20px_white] bg-gray-300 border-2 border-gray-200 rounded-3xl  flex flex-wrap gap-4 justify-center items-center m-auto mt-1 w-[85%] lg:w-[98%] md:mt-0 md:flex-wrap lg:p-5 lg:grid lg:grid-cols-4 lg:h-screen">
