...
export default function Card() {
  return (
    <div className=" bg-blue flex flex-wrap gap-4 justify-center items-center mt-4  lg: ">
      <div className="cardcontainer shadow-[0_0_20px_white]  w-96 bg-gray-100 h-80 rounded-3xl  md:bases-1/2 lg:basis-1/5 lg:w-[100]    ">
